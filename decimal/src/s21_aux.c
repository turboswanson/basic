...
int s21_is_max(s21_decimal num) {
  ...
  if (num.bits[0] == UINT_MAX && num.bits[1] == UINT_MAX &&
      num.bits[2] == UINT_MAX) {
    res = 1;
  }
...
int s21_is_add_negative(s21_decimal value1,
                        s21_decimal value2) {  // is add result negative
...
int s21_is_sub_negative(s21_decimal value1,
                        s21_decimal value2) {  // is sub result negative
