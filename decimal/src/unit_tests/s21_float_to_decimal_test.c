...
START_TEST(s21_from_float_to_decimal_wtf1) {
  s21_decimal dst1;
...
START_TEST(s21_from_float_to_decimal_wtf2) {
  s21_decimal dst1;
  float a = 1.0 / 0.0;
  s21_from_float_to_decimal(a, &dst1);
...
START_TEST(s21_from_float_to_decimal_wtf3) {
  s21_decimal dst1;
  float a = -1.0 / 0.0;
  s21_from_float_to_decimal(a, &dst1);
  ck_assert_int_eq(dst1.bits[0], 0);
...
START_TEST(s21_from_float_to_decimal_wtf4) {
  s21_decimal dst1;
  float a = 0.0 / 0.0;
...
Suite *suite_float_to_decimal(void) {
  ...
  tcase_add_test(tc, s21_from_float_to_decimal_wtf1);
  tcase_add_test(tc, s21_from_float_to_decimal_wtf2);
  tcase_add_test(tc, s21_from_float_to_decimal_wtf3);
  tcase_add_test(tc, s21_from_float_to_decimal_wtf4);
