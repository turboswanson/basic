...
START_TEST(add_17) {  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  s21_decimal res = {{0}};
  ck_assert_int_eq(0, s21_add(val1, val2, &res));  // 1
}
END_TEST
...
START_TEST(add_18) {  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  s21_set_scale(&val2, 3);
  s21_decimal res = {{0}};
  ck_assert_int_eq(0, s21_add(val1, val2, &res));  // 2
}
END_TEST
...
Suite* suite_add(void) {
  ...
  tcase_add_test(tc, add_test_wtf_4);
  tcase_add_test(tc, add_test_wtf_5);
  tcase_add_test(tc, add_test_wtf_6);
  tcase_add_test(tc, add_test_wtf_7);
  tcase_add_test(tc, add_test_wtf_8);
  tcase_add_test(tc, add_test_wtf_9);
  tcase_add_test(tc, add_test_wtf_10);
  tcase_add_test(tc, add_test_wtf_11);
  tcase_add_test(tc, add_test_wtf_12);
  tcase_add_test(tc, add_test_wtf_13);
  tcase_add_test(tc, add_test_wtf_14);
  tcase_add_test(tc, add_test_wtf_15);
  tcase_add_test(tc, add_test_wtf_16);
  tcase_add_test(tc, add_test_wtf_17);
