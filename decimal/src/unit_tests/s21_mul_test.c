...
START_TEST(s21_mul_test_wtf_12) {
...
Suite *suite_mul(void) {
  ...
  tcase_add_test(tc, s21_mul_test_wtf_4);
  tcase_add_test(tc, s21_mul_test_wtf_5);
  tcase_add_test(tc, s21_mul_test_wtf_12);
