...
START_TEST(s21_pow_test_loop_mix) {
  ck_assert_ldouble_eq_tol(pow(_i, _i), s21_pow(_i, _i), 1e-6);
  ck_assert_ldouble_eq_tol(pow(10.0 - _i, _i), s21_pow(10.0 - _i, _i), 1e-6);
}
END_TEST
...
Suite *suite_pow(void) {
  ...
  tcase_add_loop_test(tc, s21_pow_test_loop_mix, 0, 6);
