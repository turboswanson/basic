...
START_TEST(test_circle) {
  ...
  // ck_assert_ldouble_eq_tol(cos(1.0 / i), s21_cos(1.0 / i), 1e-6);
  // ck_assert_ldouble_eq_tol(cos(1.0 / i / i), s21_cos(1.0 / i / i), 1e-6);
  // ck_assert_ldouble_eq_tol(cos(1.0 / i / i / i), s21_cos(1.0 / i / i / i),
  //                          1e-6);
  // ck_assert_ldouble_eq_tol(cos(-1.0 / i), s21_cos(-1.0 / i), 1e-6);
  // ck_assert_ldouble_eq_tol(cos(-1.0 / i / i), s21_cos(-1.0 / i / i), 1e-6);
  // ck_assert_ldouble_eq_tol(cos(-1.0 / i / i / i), s21_cos(-1.0 / i / i / i),
...
START_TEST(s21_cos_test) {
  ...
  ck_assert_ldouble_eq_tol(cos(-3 * S21_PI / 2), s21_cos(-3 * S21_PI / 2),
                           1e-6);
  ck_assert_ldouble_eq_tol(cos(-S21_PI / 6), s21_cos(-S21_PI / 6), 1e-6);
  ck_assert_ldouble_eq_tol(cos(-S21_PI / 4), s21_cos(-S21_PI / 4), 1e-6);
  ck_assert_ldouble_eq_tol(cos(-S21_PI / 3), s21_cos(-S21_PI / 3), 1e-6);
  ck_assert_ldouble_eq_tol(cos(-S21_PI / 2), s21_cos(-S21_PI / 2), 1e-6);
  ...
  ck_assert_ldouble_eq_tol(cos(S21_PI), s21_cos(S21_PI), 1e-6);
  ck_assert_ldouble_eq_tol(cos(2 * S21_PI), s21_cos(2 * S21_PI), 1e-6);
  ck_assert_ldouble_eq_tol(cos(3 * S21_PI), s21_cos(3 * S21_PI), 1e-6);
  ck_assert_ldouble_eq_tol(cos(-3 * S21_PI), s21_cos(-3 * S21_PI), 1e-6);
  ck_assert_ldouble_eq_tol(cos(S21_PI / 2), s21_cos(S21_PI / 2), 1e-6);
  ck_assert_ldouble_eq_tol(cos(S21_PI / 3), s21_cos(S21_PI / 3), 1e-6);
  ck_assert_ldouble_eq_tol(cos(S21_PI / 4), s21_cos(S21_PI / 4), 1e-6);
  ck_assert_ldouble_eq_tol(cos(S21_PI / 6), s21_cos(S21_PI / 6), 1e-6);
  ck_assert_ldouble_eq_tol(cos(3 * S21_PI / 2), s21_cos(3 * S21_PI / 2), 1e-6);
  ck_assert_ldouble_eq_tol(cos(1.0), s21_cos(1.0), 1e-6);
...
Suite *suite_cos(void) {
  ...
  tcase_add_loop_test(tc, test_cos_fractional_pi_values, 0, 9);
  tcase_add_test(tc, test_cos_whole_pi_values);
