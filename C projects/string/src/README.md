...
In this project I've developed my own implementation of the string.h library in C programming language with some additions (with my own implementation of sprintf). The string.h library is the main C library for string processing. As part of the project I've worked on tasks with string data and consolidate the structured approach.
...
| 15 | n | Number of characters printed un
