...
START_TEST(s21_abs_test13) { ck_assert_int_eq(s21_abs(5), abs(5)); }
END_TEST

START_TEST(s21_abs_test14) { ck_assert_int_eq(s21_abs(-5), abs(-5)); }
END_TEST
...
START_TEST(s21_abs_loop) {
  ck_assert_int_eq(s21_abs(_i), abs(_i));
  ck_assert_int_eq(s21_abs(-_i), abs(-_i));
}
END_TEST
...
Suite *suite_abs(void) {
  ...
  tcase_add_test(tc, s21_abs_test17);
  tcase_add_test(tc, s21_abs_test);
  tcase_add_loop_test(tc, s21_abs_loop, 0, 101);
